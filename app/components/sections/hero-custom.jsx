    ...
    <Section className="relative overflow-hidden" bg={bg}>
      ...
      <Container className="relative z-1" width={width} margin="hero">
        <div className="grid items-start gap-8 lg:grid-cols-2">
          <Motion className="max-w-2xl lg:mt-8">
            {/* title */}
                    ...
                    _.get(fields, 'video') && (
                      <MotionVariant variants={fadeInFromBottom} className="relative">
                        <VideoHolder 
                          ...
                          className={{
                            figure: `z-1 aspect-w-16 aspect-h-9 overflow-hidden ${defaults.image.rounded}`,
                            video: "h-full w-full object-cover object-center"
                          }}
                        />
                      </MotionVariant>
                    )
