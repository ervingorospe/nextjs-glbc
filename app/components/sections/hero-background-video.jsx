...
export async function HeroBackgroundVideo({ data, sectionCount }) {
  const { fields } = data
    ...
    <Section className="relative overflow-hidden" bg={bg}>
      <div className="absolute inset-0 opacity-60">
        <video playsInline autoPlay muted loop className="w-full h-full object-cover object-center">
          <source src="https://fluxconsole.com/files/video/241689" type="video/mp4"/>
        </video>
      </div>
      ...
      <Container className="relative z-1" width={width} margin="hero">
        <div className="items-start">
          <Motion className="max-w-screen-lg lg:mt-8">
            {/* title */}
