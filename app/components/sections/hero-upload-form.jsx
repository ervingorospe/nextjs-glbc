...
// components
import { Title, Body, Button, FormWufooApplication } from '@/components/shared'
// constants
import { defaultHeroStyles } from '@/app/constants'

const defaults = { ...defaultHeroStyles }

export function HeroUploadForm({ data, sectionCount }) {
  const { fields } = data
    ...
    <Section className="relative" bg={bg}>
      ...
      <Container className="relative z-1" width={width} margin="hero">
        <div className="grid gap-8 lg:grid-cols-12">
          <Motion className="md:col-span-6 lg:col-span-8">
            {/* title */}
          ...
          <div className="w-full md:col-span-6 lg:col-span-4 mt-6"> 
            <FormWufooApplication data={data} body={_.get(fields, 'extraBody')} className="relative w-full bg-gray-50 rounded-lg"/>
          </div>
        </div>
      </Container>
