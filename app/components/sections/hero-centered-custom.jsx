...
export async function HeroCenteredCustom({ data, sectionCount }) {
  const { fields } = data
        ...
        <div className="grid justify-center items-center">
          <div className="">
            ...
            <Body
              ...
              size={bodySize}
              className={`mt-6 text-center ${_.get(fields, 'bodyClass') ?? _.get(fields, 'bodyClass')}`}
            />
            ...
            <Body
              ...
              size={extraBodySize}
              className={`mt-1 text-center ${_.get(fields, 'extraBodyClass') ?? _.get(fields, 'extraBodyClass')}`}
            />
