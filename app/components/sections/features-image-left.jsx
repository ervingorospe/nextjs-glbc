...
export async function FeaturesImageLeft({ data, sectionCount }) {
  const { fields } = data
          ...
          <div>
            ...
            <MotionVariant variants={fadeInFromBottom}>
              <Body
                ...
                size={bodySize}
                className={`mt-6 ${_.get(fields, 'bodyClass') ?? _.get(fields, 'bodyClass')} text-gray-200`}
              />
            </MotionVariant>
            ...
            <MotionVariant variants={fadeInFromBottom}>
              <Body
                ...
                size={extraBodySize}
                className={`mt-4 ${_.get(fields, 'extraBodyClass') ?? _.get(fields, 'extraBodyClass')} text-gray-200`}
              />
            </MotionVariant>

            {
              subCollection.length > 0 && (
                <div className="mt-7 max-w-xl space-y-8 text-base leading-7 text-secondary-200 lg:max-w-none">
                  {
...
async function Features ({ data }) {
  ...
  return (
    <MotionVariant variants={fadeInFromBottom} className="relative pl-9">
      ...
      <dd className="inline"> {_.get(fields, 'body')}</dd>
    </MotionVariant>
  )
}