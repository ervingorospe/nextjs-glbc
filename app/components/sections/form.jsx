...
export async function Form({ data, sectionCount }) {
  const { fields } = data
  ...
  return (
    <Section className="relative overflow-hidden" bg={bg}>
      <Container width={width} margin="" className="relative">
        <div className="mt-8 grid">
          ...
          <FormWufoo data={data} className="relative max-w-full bg-white border rounded-lg"/>
        </div>
      </Container>
    </Section>
  )
