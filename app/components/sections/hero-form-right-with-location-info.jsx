...
// components
import { Title, Body, Button, FormWufoo, LocationInfo } from '@/components/shared'
// constants
import { defaultHeroStyles } from '@/app/constants'

const defaults = { ...defaultHeroStyles }

export function HeroFormRightWithLocationInfo({ data, sectionCount }) {
  const { fields } = data
    ...
    <Section className="relative" bg={bg}>
      ...
      <Container className="relative z-1" width={width} margin="hero">
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <FormWufoo data={data} className="relative w-full bg-gray-50 lg:max-w-2xl rounded-lg lg:max-w-lg max-w-[600px] min-h-[399px]"/>
        </div>
      </Container>
